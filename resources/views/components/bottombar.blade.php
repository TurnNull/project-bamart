...
<div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-300 px-4 py-3 z-50">
    ...
    <div class="container mx-auto px-4 py-3 flex items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-3 min-w-0">
            ...
            <div class="text-sm text-black leading-tight truncate max-w-[120px] sm:max-w-[200px] md:max-w-[350px]">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="hidden sm:flex flex-col text-right">
                ...
                <span id="totalHarga" class="text-xl font-semibold text-fuchsia-900">
                    Rp200.000.000
                </span>
            </div>
        </div>
        ...
        <div class="flex items-center gap-3 shrink-0">
            ...
            <!-- Beli Sekarang -->
            <a href="#"
                class="py-2 px-4 border-2 border-[#7D1972] text-[#7D1972] rounded-2xl font-medium hover:bg-[#7D1972] hover:text-white">Beli
                Sekarang</a>

            <!-- Tambah Ke Cart -->
            <a href="#"
                class="py-2 px-4 border-2 border-[#7D1972] text-white bg-[#7D1972] rounded-2xl font-medium hover:bg-white hover:text-[#7D1972]">Tambah
                Ke Cart</a>
            ...
            <button class="w-12 h-12 flex items-center justify-center rounded-full shadow bg-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
                    ...
                    <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2
                        5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81
