...
@section('content')
    ...
    <div class="w-full max-w-[1400px] mx-auto px-4 md:px-8 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {{-- === TOKO === --}}
            <div
                class="lg:col-span-1 md:col-span-2 lg:md:col-span-1 max-w-full md:max-w-md lg:max-w-sm 
        ...
        <div class="relative w-full">
            ...
            <button id="btn-left"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="size-5 sm:size-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
            ...
            {{-- SLIDER PRODUK --}}
            <div id="slider" class="flex gap-4 sm:gap-5 overflow-x-scroll scroll-smooth no-scrollbar pr-8 sm:pr-10">

                @foreach (range(1, 10) as $i)
                    <div
                        class="min-w-[150px] sm:min-w-[180px] md:min-w-[200px] rounded-xl overflow-hidden 
