...
<section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
  <div class="mx-auto max-w-2xl px-4 2xl:px-0">
      ...
      <p class="text-gray-500 dark:text-gray-400 mb-6 md:mb-8">
        Your order 
        <a href="#" class="font-medium text-gray-900 dark:text-white hover:underline">#7564804</a> 
      ...
      <div class="flex items-center space-x-4">
          ...
          <a href="#"
             class="text-white bg-[#7D1972] hover:bg-[#7D1972] focus:ring-4 focus:ring-[#7D1972]/30 font-medium rounded-lg text-sm px-5 py-2.5 
             dark:bg-[#7D1972] dark:hover:bg-[#7D1972] focus:outline-none dark:focus:ring-[#7D1972]/30">
             Track your order
          </a>
